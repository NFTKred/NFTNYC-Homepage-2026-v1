...
const TYPE_META: Record<VerticalResource['type'], { icon: typeof FileText; label: string }> = {
...
const ALL_TYPES: VerticalResource['type'][] = ['blog', 'youtube', 'podcast', 'tweet', 'paper', 'news'];
