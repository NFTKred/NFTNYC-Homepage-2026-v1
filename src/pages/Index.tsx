...
import LiveGalleryHero from "@/components/LiveGalleryHero";

/**
 * Homepage (/) - the live NFT.NYC 2026 landing page.
 *
 * Hero: LiveGalleryHero (Concept C - "live gallery ground") - a full-bleed
 * mosaic of currently-collected NFTs from collect.nft.nyc, with a wordmark
 * and two coequal CTAs on top ("Start collecting" primary, "Register to
 * attend" ghost). Below the hero: tokenization-layer statement, the
 * NeuralMesh diagram, stats, featured speakers pulled live from Sessionize,
 * our North Star values, Why New York, and the rest of the standard
 * homepage sections.
 *
 * This file was previously the /beta preview - promoted to / on 19 Aug 2026.
 * The old hero markup (large centered wordmark + single Register CTA) is
 * gone; anything the beta preview iterated on is now the production hero.
 */
