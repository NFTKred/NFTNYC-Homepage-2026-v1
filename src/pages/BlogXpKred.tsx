      ...
      <article style={{ padding: 'calc(4rem + 56px + 50px) 1.5rem 4rem' }}>
        <div className="max-w-[720px] mx-auto">
          ...
          {[
            ...
            { q: 'Do I need KYC to earn Kredits?', a: 'No. KYC is required only for USDC payouts, fund withdrawals, and transferring Regulated Virtual Assets off-platform. Earning and spending Kredits requires no identity verification.' },
