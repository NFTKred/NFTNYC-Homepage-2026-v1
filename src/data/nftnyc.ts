...
export const ECOSYSTEMS: Ecosystem[] = [
  { id: 'ai', name: 'AI Identity Tokenization', subtitle: 'ERC-8004 Reputation', icon: '🤖', color: '#3B82F6',
  ...
  { id: 'gaming', name: 'Game Tokenization', subtitle: 'Player-Owned Assets', icon: '🎮', color: '#8B5CF6',
  ...
  { id: 'infra', name: 'On-Chain Infrastructure', subtitle: 'L1/L2, ZK Identity, Wallets', icon: '⛓️', color: '#06B6D4',
    desc: 'Layer 1 and Layer 2 blockchains, rollups, wallets, ZK identity, NFT liquidity layers, and fully on-chain systems.',
    examples: ['L2 Scaling', 'ZK Proofs', 'Smart Wallets'],
    subs: ['L2 Scaling', 'ZK Proofs'] },
  ...
  { id: 'creator', name: 'Creator Economy', subtitle: 'Community-Owned IP', icon: '💡', color: '#F59E0B',
  ...
  { id: 'defi', name: 'DeFi', subtitle: 'NFT Lending & Onchain Finance', icon: '💰', color: '#10B981',
    desc: 'NFT lending, fractionalization, DeFi infrastructure, and meme coins as community capital.',
    examples: ['NFT Lending', 'Fractionalization'],
    subs: ['NFT Lending', 'Fractionalization'] },
  { id: 'rwa', name: 'RWA Tokenization', subtitle: 'Real-World Assets Onchain', icon: '🏛️', color: '#EF4444',
    desc: 'Tokenized real estate, treasuries, commodities, and securities. Bringing trillions in traditional assets onchain with programmable compliance and 24/7 settlement.',
    examples: ['Tokenized Treasuries', 'Real Estate', 'Commodities'],
    subs: ['Tokenized Treasuries', 'Real Estate'] },
  ...
  { id: 'culture', name: 'Culture, Art & Music', subtitle: 'Communities, Attribution, Ownership', icon: '🎵', color: '#D946EF',
    desc: 'Digital art, generative art, and AI-generated art with on-chain attribution. Music royalty ownership. Internet-native communities, NFT-native media, creator-led ecosystems, and meme culture.',
    examples: ['Generative Art', 'Music Royalties', 'Meme Culture'],
    subs: ['Generative Art', 'Music Royalties'] },
  { id: 'domains', name: 'DNS ENS Domain Tokens', subtitle: 'Onchain Naming & Identity', icon: '🌐', color: '#14B8A6',
    desc: 'Human-readable names for wallets, websites, and agents. ENS, DNS integrations, and domain NFTs serve as the identity layer for the onchain economy.',
    examples: ['.Kred', 'ENS', 'DNS Bridge'],
    subs: ['.Kred', 'ENS'] },
  { id: 'desci', name: 'DeSci · Longevity Tokenization', subtitle: 'Tokenized Science & Health', icon: '🧬', color: '#84CC16',
    desc: 'Decentralized science funding, longevity research, tokenized IP for biotech breakthroughs, and patient-owned health data. A new model for accelerating research.',
    examples: ['VitaDAO', 'Longevity IP', 'Research DAOs'],
    subs: ['VitaDAO', 'Longevity IP'] },
...
// Connections between verticals (indices refer to ECOSYSTEMS above).
// 12 total: 0=ai 1=gaming 2=infra 3=social 4=creator 5=defi 6=rwa 7=brands 8=culture 9=domains 10=desci 11=marketplaces
...
export const PAST_EVENTS: PastEvent[] = [
  ...
  },
  {
    ...
    image: 'https://f005.backblazeb2.com/file/PB-HubSpot/pastevents-2021-3.jpg',
  },
  {
    name: 'NFT.NYC 2020',
    year: '2020',
