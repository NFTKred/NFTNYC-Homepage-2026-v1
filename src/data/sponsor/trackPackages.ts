...
export const trackPackages: Record<string, TrackPackage[]> = {
  "AI Identity Tokenization": [
    ...
    },
    {
      ...
      price: "$7,500",
      description: "Reach the NFT.NYC community members most passionate about AI and on-chain identity with a dedicated feature in a community update and supporting social posts — tailored to builders, researchers, and enterprises in the AI identity space.",
  ...
  "Game Tokenization": [
    ...
    },
    {
      ...
      price: "$7,500",
      description: "Reach the NFT.NYC gaming community with a dedicated feature in a community update and supporting social campaign — tailored to gamers, game developers, and gaming infrastructure builders in the web3 space.",
      includes: [...marketingIncludes],
    },
  ],
  "On-Chain Infrastructure": [
    ...
    },
    {
      ...
      price: "$7,500",
      description: "Reach the NFT.NYC developer and infrastructure community with a dedicated feature in a community update and supporting social campaign — tailored to protocol engineers, L2 builders, and technical founders.",
      includes: [...marketingIncludes],
    },
  ],
  "Social NFTs": [
  ...
  "Creator Economy": [
    ...
    },
    {
      ...
      price: "$7,500",
      description: "Reach the NFT.NYC creator community with a dedicated feature in a community update and supporting social campaign — tailored to independent artists, musicians, writers, and the platforms that serve them.",
      includes: [...marketingIncludes],
    },
  ],
  "DeFi": [
  ...
  "RWA Tokenization": [
    ...
    },
    {
      ...
      price: "$7,500",
      description: "Reach the NFT.NYC institutional and RWA community with a dedicated feature in a community update and supporting social campaign — tailored to real estate tokenizers, fund managers, and compliance-focused builders.",
      includes: [...marketingIncludes],
    },
  ],
  "Brands & Engagement": [
    ...
    },
    {
      ...
      price: "$7,500",
      description: "Reach the NFT.NYC brand and enterprise community with a dedicated feature in a community update and supporting social campaign — tailored to CMOs, brand strategists, and loyalty program managers exploring web3.",
      includes: [...marketingIncludes],
    },
  ],
  "Culture, Art & Music": [
    ...
    },
    {
      ...
      price: "$7,500",
      description: "Reach the NFT.NYC art and music community with a dedicated feature in a community update and supporting social campaign — tailored to digital artists, musicians, collectors, and gallery curators.",
      includes: [...marketingIncludes],
    },
  ],
  "DNS ENS Domain Tokens": [
    ...
    },
    {
      ...
      price: "$7,500",
      description: "Reach the NFT.NYC domain and identity community with a dedicated feature in a community update and supporting social campaign — tailored to ENS enthusiasts, domain investors, and web3 identity builders.",
      includes: [...marketingIncludes],
    },
  ],
  "DeSci · Longevity Tokenization": [
    ...
    },
    {
      ...
      price: "$7,500",
      description: "Reach the NFT.NYC DeSci and longevity community with a dedicated feature in a community update and supporting social campaign — tailored to researchers, biotech founders, and science-focused investors.",
      includes: [...marketingIncludes],
    },
  ],
  "NFT Marketplaces": [
    ...
    },
    {
      ...
      price: "$7,500",
      description: "Reach the NFT.NYC marketplace and trading community with a dedicated feature in a community update and supporting social campaign — tailored to collectors, traders, and marketplace operators.",
      includes: [...marketingIncludes],
    },
  ],
};
