...
export const defaultAlaCarte: AlaCarteItem[] = [
  {
    ...
    price: "$12,000",
    description: "15 second video clip featured in Times Square, included in the NFT.NYC 20 Minute Kickoff Roadblock. Reach the NFT.NYC community AND the ~330,000 daily pedestrians in Times Square — ~1.5M daily impressions, part of 50M visitors per year (Times Square Alliance).",
    availability: "Limited"
  },
  {
    id: 102,
  ...
  },
  {
    ...
    name: "AV Loop Video",
    price: "$2,500",
    description: "Run a 30-second video clip in the AV loop playing across screens throughout the event venue. High visibility wherever attendees are — between sessions, in walkways, and around activation areas.",
    availability: "Limited"
  },
  {
    id: 107,
