...
export const PAGE_META: Record<string, PageMetaEntry> = {
  ...
  sprint3: {
    ...
    description:
      "The final Kred Flash Sprint, Sep 1-3: remix the Cat Remix Matrix and make named agents discuss, debate, govern, and score. Free to enter, live engineer support.",
    path: "/sprint3",
    ogImage: "/og/speak.png",
  },
  sprintfeedback: {
