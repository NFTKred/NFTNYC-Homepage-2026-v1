...
export const PAGE_META: Record<string, PageMetaEntry> = {
  ...
  vibesprint: {
    title: "Kred Flash Sprints - Three Sprints to NFT.NYC 2026",
    description: "Build a next generation Domain Reseller on the Kred TLD. Three 48-hour sprints from 12 August. Every submission earns. Demo Day at NFT.NYC 2026.",
    path: "/vibesprint",
    ogImage: "/og/speak.png",
  },
  sprint1: {
  ...
  sprint3: {
    ...
    description:
      "The final Kred Flash Sprint, Aug 31 - Sep 2: remix the Cat Remix Matrix and make named agents discuss, debate, govern, and score. Free to enter, live engineer support.",
    path: "/sprint3",
    ogImage: "/og/speak.png",
  },
  sprintfeedback: {
