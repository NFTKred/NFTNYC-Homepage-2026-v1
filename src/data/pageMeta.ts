...
export const PAGE_META: Record<string, PageMetaEntry> = {
  speak: {
    ...
    description: "Round 3 is open — the third and final round of speaker submissions for NFT.NYC 2026. Applications close 24 July at midnight. Keynotes, panels, and fireside chats across 12 industry tracks.",
    path: "/speak",
