...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // z-[110] keeps the dialog above the fixed header (z-100) and
      // the urgency banner (z-101) so the close button is always
      // reachable, especially on mobile.
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // z-[110] matches DialogOverlay above, sitting above the
        // header (z-100) and urgency banner (z-101).
